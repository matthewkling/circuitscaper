...
The `cs_*` functions expose several additional Circuitscape features beyond
the basics.
...
to assign different injection strengths per node:
...
developed areas). Pass a raster where cells sharing the same positive integer
value are short-circuited:
